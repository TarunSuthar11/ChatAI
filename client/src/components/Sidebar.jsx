...
export default function Sidebar() {
  ...
  return (
    <div
      className={` flex flex-col bg-(--secondary-bg-color)  border-r border-(--ternary-bg-color) text-(--primary-text-color) shadow-md overflow-scroll h-screen fixed md:static inset-y-0 left-0 w-64  transition-transform duration-300 z-30
    ...
    >
      ...
      <div className="flex-col   bg-(--secondary-bg-color)  w-full  sticky z-40 top-13  ">
        ...
        <a href="https://ai.google.dev/gemini-api/docs/libraries#new-libraries" target="_blank" rel="noopener noreferrer">
          <div className="px-3.5 py-1.5 mx-1.5 flex items-center gap-2 hover:bg-(--ternary-bg-color) rounded-2xl">
            <LiaGemSolid className="text-xl" />
            <span className="text-md font-light">Other tools</span></div>
        </a>
      ...
      <div className="px-4 py-3 pb-4 flex align-self-end items-center gap-2 border-t border-(--ternary-bg-color) sticky z-40 bottom-0 left-0 bg-(--secondary-bg-color)" >
